...
print ("*" * szer)
print ("│ {:9s} │ {:3d} │ {:4d} │ {:5.2f} │".format(I1, G1, H1, BMI1))
print ("│ {:9s} │ {:3d} │ {:4d} │ {:5.2f} │".format(I2, G2, H2, BMI2))
print ("│ {:9s} │ {:3d} │ {:4d} │ {:5.2f} │".format(I3, G3, H3, BMI3))
print ("_" * szer)
